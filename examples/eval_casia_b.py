...
def main():
    ...
    ap.add_argument("--conds", type=str, default="nm")
    ...
    records = scan_casia_b(Path(args.data_root), include_views=views, include_conditions=conds, min_frames=2)
    dataset = build_casia_b_dataset(records, seq_len=args.seq_len, height=args.height, width=args.width)
